...
# Mode normal, env 15 sec
for i, (batch, label) in enumerate(traffic_volume_csv_gz_ds.repeat(20)):
  if i % 40 == 0:
    print('.', end='')
print()

# Mode cache, env 1 sec
...
# Methode ligne par ligne, prend environ 17 secondes
BATCH_SIZE=2048
fonts_ds = tf.data.experimental.make_csv_dataset(
    file_pattern = "fonts/*.csv",
...
# Methode lot de lignes, prend environ 5 secondes
